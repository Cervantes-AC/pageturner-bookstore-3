...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div class="stat-card">
            <div class="stat-icon {{ auth()->user()->hasVerifiedEmail() ? 'bg-emerald-50' : 'bg-amber-50' }}">
            ...
            <div>
                ...
                @if(!auth()->user()->hasVerifiedEmail())
                    <a href="{{ route('verification.notice') }}" class="text-xs text-primary-600 font-medium">Verify now →</a>
                @endif
            </div>
        </div>
        <div class="stat-card">
            <div class="stat-icon {{ auth()->user()->two_factor_enabled ? 'bg-emerald-50' : 'bg-gray-50' }}">
            ...
            <div>
                <p class="text-xs text-gray-500 font-medium">Two-Factor Auth</p>
                ...
                <a href="{{ route('profile.edit') }}" class="text-xs text-primary-600 font-medium">Manage →</a>
            </div>
        </div>
        <div class="stat-card">
        ...
        <div class="card">
            ...
            <div class="divide-y divide-gray-50">
                ...
                <div class="px-6 py-10 text-center">
                    ...
                    <a href="{{ route('books.index') }}" class="btn-primary btn-sm inline-flex">Start Shopping</a>
                </div>
                @endforelse
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="card p-5">
            ...
            <div class="grid grid-cols-3 gap-3">
                <a href="{{ route('books.index') }}" class="flex flex-col items-center gap-2 p-3 rounded-xl bg-gray-50 hover:bg-primary-50 hover:text-primary-700 transition-colors text-gray-600 text-center">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                    </svg>
                    <span class="text-xs font-medium">Browse</span>
                </a>
                <a href="{{ route('orders.index') }}" class="flex flex-col items-center gap-2 p-3 rounded-xl bg-gray-50 hover:bg-primary-50 hover:text-primary-700 transition-colors text-gray-600 text-center">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                    </svg>
                    <span class="text-xs font-medium">Orders</span>
                </a>
                <a href="{{ route('profile.edit') }}" class="flex flex-col items-center gap-2 p-3 rounded-xl bg-gray-50 hover:bg-primary-50 hover:text-primary-700 transition-colors text-gray-600 text-center">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="card p-5">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="{{ route('export.my-data') }}" class="btn-secondary btn-sm">
