...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
        ...
        <div class="lg:col-span-1">
            <div class="card overflow-hidden aspect-[3/4] flex items-center justify-center bg-gray-50">
                @if($book->cover_image)
        ...
        <div class="lg:col-span-2">
            <div class="flex items-start justify-between gap-4 mb-2">
                <a href="{{ route('categories.show', $book->category) }}"
                   class="badge-primary text-xs">{{ $book->category->name }}</a>
                @if($book->is_featured)
            ...
            <p class="text-lg text-gray-500 mb-1">by <span class="font-medium text-gray-700">{{ $book->author }}</span></p>
            ...
            <p class="text-xs text-gray-400 mb-5">ISBN: {{ $book->isbn }}</p>
            ...
            @auth
                ...
                <form action="{{ route('cart.add', $book) }}" method="POST" class="flex items-center gap-3 mb-4">
                    ...
                    <button type="submit" class="btn-primary btn-lg flex-1 sm:flex-none">
                ...
                @endif
            @else
                <a href="{{ route('login') }}" class="btn-primary btn-lg inline-flex mb-4">
                    Sign in to Order
                </a>
            @endauth
    ...
    <div class="border-t border-gray-100 pt-10">
        ...
        <div class="alert-info mb-6">
            ...
            <a href="{{ route('login') }}" class="font-semibold underline">Sign in</a> to write a review.
        </div>
        @endauth
        ...
        <div class="space-y-4">
            ...
            <div class="card p-5">
                <div class="flex items-start justify-between gap-4">
                    <div class="flex items-center gap-3">
                        <div class="w-9 h-9 bg-primary-100 rounded-full flex items-center justify-center text-primary-700 font-bold text-sm flex-shrink-0">
            ...
            <div class="card p-8 text-center text-gray-400">
                <p class="text-sm">No reviews yet. Be the first to review this book!</p>
            </div>
            @endforelse
        </div>
    </div>
