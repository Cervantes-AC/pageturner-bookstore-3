        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <form action="{{ route('orders.store') }}" method="POST">
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div>
                        ...
                        <textarea id="shipping_address" name="shipping_address" 
                                  ...
                                  class="w-full border-gray-300 rounded-lg shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('shipping_address') }}</textarea>
                ...
                <div class="border-t border-gray-200 pt-4 mb-6">
                    <h3 class="font-semibold text-lg mb-4 text-gray-900">Order Summary</h3>
                    <div class="space-y-3">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('cart.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300 transition font-medium">
                        Back to Cart
                    </a>
