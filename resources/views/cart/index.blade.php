...
<div class="max-w-6xl mx-auto">
    @if(empty($cartItems))
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-12 text-center">
            ...
            <p class="text-gray-600 mb-8">Start adding books to your cart to see them here</p>
                ...
                @foreach($cartItems as $item)
                    <div class="card">
                        <div class="p-6 flex items-center gap-6">
                            <div class="w-24 h-32 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex-shrink-0 flex items-center justify-center overflow-hidden">
                            ...
                            <div class="flex-grow">
                                <h3 class="font-bold text-lg text-gray-900 mb-1">
                                    <a href="{{ route('books.show', $item['book']) }}" class="hover:text-emerald-600 transition-colors">
                                        {{ $item['book']->title }}
                                    </a>
                                </h3>
                                <p class="text-gray-600 mb-2">by {{ $item['book']->author }}</p>
                                <p class="text-emerald-600 font-semibold text-lg">₱{{ number_format($item['book']->price, 2) }}</p>
                            ...
                            <div class="flex flex-col items-end gap-4">
                                <form action="{{ route('cart.update', $item['book']) }}" method="POST" class="flex items-center gap-2">
                                    ...
                                    <input type="number" name="quantity" value="{{ $item['quantity'] }}"
                                           ...
                                           class="w-20 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
