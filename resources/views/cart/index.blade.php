...
<div class="max-w-4xl mx-auto">
    ...
    @if(empty($cartItems))
        <x-alert type="info">
            Your cart is empty. <a href="{{ route('books.index') }}" class="text-indigo-600 hover:underline">Browse books</a>
        </x-alert>
    @else
        ...
        <div class="mt-6 bg-white rounded-lg shadow p-6">
            ...
            <div class="flex gap-4">
                ...
                <a href="{{ route('books.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded hover:bg-gray-300 transition">
                    Continue Shopping
                </a>

                <a href="{{ route('cart.checkout') }}" class="bg-indigo-600 text-white px-6 py-2 rounded hover:bg-indigo-700 transition ml-auto">
                    Proceed to Checkout
                </a>
            </div>
        </div>
