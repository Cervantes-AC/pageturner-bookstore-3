                ...
                <div class="hidden md:flex ml-10 space-x-4">
                    ...
                    @auth
                        @if(auth()->user()->isAdmin())
                            <a href="{{ route('admin.dashboard') }}" class="hover:bg-indigo-700 px-3 py-2 rounded-md">Dashboard</a>
                            ...
                            <a href="{{ route('admin.import-export.import') }}" class="hover:bg-indigo-700 px-3 py-2 rounded-md">Import</a>
                            <a href="{{ route('admin.import-export.export') }}" class="hover:bg-indigo-700 px-3 py-2 rounded-md">Export</a>
                        @endif
                    @endauth
                </div>
            </div>
