...
<div class="py-8 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        {{-- Tamper-proof Checksum Verification --}}
        @if($audit->checksum)
        <div class="mb-6 p-3 bg-gray-50 rounded-lg border border-gray-200 text-xs">
            <div class="flex items-center gap-2 mb-1">
                <svg class="w-4 h-4 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                </svg>
                <span class="font-semibold text-gray-700">Tamper-Proof Verification</span>
            </div>
            <div class="flex items-center gap-1 text-gray-600">
                <span>SHA-256 checksum:</span>
                <code class="bg-white px-1.5 py-0.5 rounded border text-[10px]">{{ $audit->checksum }}</code>
                <span class="text-green-600 font-medium ml-1">✓ Verified</span>
            </div>
            <p class="text-gray-400 mt-1">This checksum ensures the audit record has not been altered since creation.</p>
        </div>
        @endif
